...
object LocalizationManager {
    ...
    private val languageChangeListeners = mutableListOf<(Language) -> Unit>()
     ...
     */
    fun addLanguageChangeListener(listener: (Language) -> Unit) {
     ...
     */
    fun removeLanguageChangeListener(listener: (Language) -> Unit) {
